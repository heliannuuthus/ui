...
```tsx title="showcases/masonry/cases/basic-usage.tsx"
import { Masonry, type MasonryItem } from '@heliannuuthus/ui';
...
<Masonry columns={3} minColumnWidth={180} gap={[14, 20]} items={items} />;
```
...
```tsx title="showcases/masonry/cases/adaptive-number-of-columns.tsx"
import { Masonry } from '@heliannuuthus/ui';

<Masonry columns={6} minColumnWidth={140} gap={14} items={cards} />;
```
...
```tsx title="showcases/masonry/cases/cross-column-content.tsx"
import { Masonry } from '@heliannuuthus/ui';
