...
<ApiTable
  ...
  rows={[
    ...
    },
    {
      ...
      defaultValue: 'true',
      description:
        'Show or hide both navigation buttons, or configure them in one object.',
      name: 'controls',
      type: 'boolean | CarouselNavigationOptions',
    },
    {
    ...
    {
      component: 'Carousel',
      defaultValue: 'undefined (dots)',
      description:
        'Show dots by default, set false to hide them, or pass options to customize pagination.',
      name: 'pagination',
      type: 'false | CarouselPaginationOptions',
    },
    {
    ...
    },
    {
      ...
      defaultValue: null,
      description:
        'Render the complete page turner from page state and controls; cannot be used with renderDot.',
      name: 'render',
      type: '(controls: CarouselControls) => ReactNode',
    },
    {
      component: 'Carousel',
      defaultValue: 'false',
