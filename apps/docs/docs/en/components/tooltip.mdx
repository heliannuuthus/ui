...
```tsx title="showcases/tooltip/cases/basic-usage.tsx"
...
```tsx title="showcases/tooltip/cases/twelve-placements.tsx"
...
```tsx title="showcases/tooltip/cases/arrow.tsx"
import { Button, Tooltip } from '@heliannuuthus/ui';
...
```tsx title="showcases/tooltip/cases/controlled-state-and-container.tsx"
import { Button, Tooltip } from '@heliannuuthus/ui'
