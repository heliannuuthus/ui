...
```tsx title="showcases/badge/cases/basic-usage.tsx"
...
```tsx title="showcases/badge/cases/anchored-notifications.tsx"
...
```tsx title="showcases/badge/cases/status-dot.tsx"
import { Badge, Button } from '@heliannuuthus/ui';
...
```tsx title="showcases/badge/cases/style-extensions.tsx"
import { Badge } from '@heliannuuthus/ui';
