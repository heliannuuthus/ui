...
```tsx title="showcases/input-number/cases/basic-usage.tsx"
...
```tsx title="showcases/input-number/cases/localized-formatting.tsx"
import { Input } from '@heliannuuthus/ui';
...
```tsx title="showcases/input-number/cases/sizes-and-states.tsx"
<Input.Number size="sm" defaultValue={8} />
