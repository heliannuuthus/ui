...
```tsx title="showcases/pagination/cases/basic-usage.tsx"
...
```tsx title="showcases/pagination/cases/complete-data-pagination.tsx"
import { Pagination } from '@heliannuuthus/ui';
...
```tsx title="showcases/pagination/cases/simple-and-disabled-states.tsx"
<Pagination
  defaultCurrent={6}
  defaultPageSize={10}
  total={120}
