...
function ComboboxInput({
  ...
  return (
    <Group className={cn('w-auto', className)}>
      ...
      <GroupAddon align="inline-end">
        {showTrigger && (
          <Button
            ...
            className="group-has-data-[slot=combobox-clear]/group:hidden data-pressed:bg-transparent"
            disabled={disabled}
          />
        )}
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        'flex min-h-9 flex-wrap items-center gap-1.5 rounded-3xl border border-input bg-background bg-clip-padding px-3 py-1.5 text-sm transition-[color,box-shadow,background-color,border-color] hover:border-primary/35 focus-within:border-primary focus-within:ring-3 focus-within:ring-primary/20 has-aria-invalid:border-destructive has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20 has-data-[slot=combobox-chip]:px-1.5 dark:has-aria-invalid:border-destructive/50 dark:has-aria-invalid:ring-destructive/40',
        className
      )}
      {...props}
    />
